...
class TechnologiesControllerTest < ActionController::TestCase
  ...
  test "should create technology" do
    assert_difference('Technology.count') do
      post :create, technology: { description: @technology.description, name: @technology.name, website: @technology.website }
    end
  ...
  test "should update technology" do
    put :update, id: @technology, technology: { description: @technology.description, name: @technology.name, website: @technology.website }
    assert_redirected_to technology_path(assigns(:technology))
  end
